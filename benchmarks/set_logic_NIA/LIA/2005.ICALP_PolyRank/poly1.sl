...
(define-fun trans_fun ((c Int) (i Int) (j Int) (i0 Int) (j0 Int) (an Int) (bn Int)
                       (c! Int) (i! Int) (j! Int) (i0! Int) (j0! Int) (an! Int) (bn! Int)) Bool
  (and (= an! an) (= bn! bn) (= i0! i0) (= j0! j0)
       (or (and (< an i) (< bn j) (= c! c) (= i! i) (= j! j))
           (and (>= an i) (>= bn j)
                (= c! (+ c 1)) (= i! i) (= j! (+ j 1)))
           (and (>= an i) (>= bn j)
                (= c! (+ c 1)) (= i! (+ i 1)) (= j! j))
