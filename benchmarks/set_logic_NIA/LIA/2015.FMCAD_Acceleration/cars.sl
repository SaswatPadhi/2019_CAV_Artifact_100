...
(define-fun trans_fun ((x1 Int) (x2 Int) (x3 Int) (v1 Int) (v2 Int) (v3 Int) (t Int) (RETURN Int)
                     (x1! Int) (x2! Int) (x3! Int) (v1! Int) (v2! Int) (v3! Int) (t! Int) (RETURN! Int)) Bool
  (and (= RETURN 0)
       (or (and (not (>= (+ v2 5) 0)) (= RETURN! 1))
           (and (>= (+ v2 5) 0) (= RETURN! RETURN)))
       (or (and (not (<= v2 5)) (= RETURN! 1))
           (and (<= v2 5) (= RETURN! RETURN)))
       (or (and (or (and (not (>= (- (- (* 2 x2) x1) x3) 0)) (= RETURN! 1))
                    (and (>= (- (- (* 2 x2) x1) x3) 0) (= RETURN! RETURN)))
                (= x1! (+ x1 v1))
                (= x3! (+ x3 v3))
                (= x2! (+ x2 v2))
                (= v2! (- v2 1))
                ...
                (= v3! v3)
                (= t! (+ t 1)))
           (and (or (and (not (<= (- (- (* 2 x2) x1) x3) 0)) (= RETURN! 1))
                    (and (<= (- (- (* 2 x2) x1) x3) 0) (= RETURN! RETURN)))
                (= x1! (+ x1 v1))
                (= x3! (+ x3 v3))
                (= x2! (+ x2 v2))
